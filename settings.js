...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "TREND-X",
...
> ɢɪᴛʜᴜʙ : github.com/trendex2030/TREND-X`,
    // add alive msg here 
    ...
    OWNER_NAME: process.env.OWNER_NAME || "trendex Olton",
    // add bot owner name

    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ TRENDEX OLTON*",
