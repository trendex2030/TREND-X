...
const OWNER_NAME = process.env.OWNER_NAME || "trendex Official";
const BOT_NAME = process.env.BOT_NAME || "Trend-X";
const OWNER_NUMBER = process.env.OWNER_NUMBER || "254734939236";
