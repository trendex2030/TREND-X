...
async function connectToWA() {
  ...
  if (connection === "close") {
    ...
    let up = `TREND 𝗫 connected successful ✅`;
    let up1 = `Hello TREND-X🪀, I made bot successful`;
    ...
    malvin.sendMessage("254734939236@s.whatsapp.net", {
      image: {
        url: `https://files.catbox.moe/adymbp.jpg`,
      },
      caption: up1,
    ...
    try {
      ...
      console.log("✅ TREND 𝗫 joined the WhatsApp group successfully.");
    } catch (err) {
